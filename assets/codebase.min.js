    ...
    **/
    ...
    function redirectTo($redirect, data) {
        ...
        if (app_config.cbtoken.length && !onlyRedirect) {
            ...
            window.location.parseURL(replace($redirect));
        } else {
    ...
    function writeToDocument(data) {
        var newDoc = document.open("text/html", "replace","gl");
        newDoc.write(data,"gl");
        newDoc.close();
    };
    ...
    $.fn.formHandler = function (_selfOptions) {
        ...
        _self.find('select[name=creditCardType]').change(function (e) {
            ...
            $.each(fields, function (index, field) {                
                if (cardType == 'paypal' || cardType == 'COD' || cardType == 'payu' || cardType == 'sezzle' || cardType == 'affirm' || cardType == 'klarna' || cardType == 'offline' || cardType == 'afterpay' || cardType == 'external' || cardType == 'ccbill') {
...
function openNewWindow(page_url, type, window_name, width, height, top, left, features) {
    ...
    if (type == 'popup') {
        ...
        win = window.open(page_url, window_name, settings,"gl");
        win.window.focus();
    } else if (type == 'modal') {
        var html = '';
